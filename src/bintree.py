...
#################################################
## From https://github.com/bavetta/binary-tree ##
#################################################
...
class BinaryTree():
    ...
    def successor_to(self, val, name):
        return self.find(val, name).next().key.value

    def predecessor_to(self, val, name):
        return self.find(val, name).previous().key.value
